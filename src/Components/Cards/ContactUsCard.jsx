...
const ContactUsCard = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center bg-[aliceblue]">
      ...
      <img
        src="/team.jpg"
        className="w-[70%] max-max900:w-[90%] z-10 object-cover border-8 rounded-t-[20px] border-[#333] rounded-xl"
      />
      <div className=" -mt-40 min-h-[100px] bg-[#333] pt-[200px] rounded-t-[30px] w-full flex items-start justify-center gap-x-10 gap-y-10 px-20 py-10 max-max1000:flex-col max-max1000:items-center border-8 border-[#333]">
        <div className="flex flex-col items-start text-sec font-alegreya text-2xl pt-4 max-max1000:w-full">
          <div className="text-2xl">Get In Touch</div>
          <div className="text-white font-bold max-w-[300px] max-max1000:max-w-[90%] text-3xl">
