...
const ContactUsCard = () => {
  ...
  const service_id = "service_ezlwfpl";
  const template_id = "template_q0tcgz3";
  const public_key = "WWyT310GholpRpY1T";
    ...
    <div className="w-full flex flex-col items-center bg-[aliceblue] relative overflow-hidden">
      ...
      >
        ...
        <motion.span
          ...
          transition={{ duration: 1.2, type: 'spring', repeat: Infinity, repeatType: 'reverse' }}
        >
          Tackle
        </motion.span>
        ...
        <motion.span
          ...
          transition={{ duration: 1.5, type: 'spring', repeat: Infinity, repeatType: 'reverse' }}
        >
          Team
        </motion.span>
        <motion.span
          ...
          transition={{ duration: 1.5, type: 'spring', repeat: Infinity, repeatType: 'reverse', delay: 0.5 }}
        >
          !
        </motion.span>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div className="text-[1rem] w-[350px] mt-5 max-max1000:w-[100%] max-max1000:text-[1.2rem] !text-xl">
            &quot;Now is the perfect time to turn your ideas into reality by starting your project with confidence and enthusiasm, creating something extraordinary and impactful.&quot;
          </div>
        </motion.div>
