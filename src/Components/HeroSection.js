      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-16 flex flex-col md:flex-row items-center ">
          ...
          <div className="md:w-1/2 text-white pt-20 text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4"> Grow your business faster with</h1>
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white"> FluxtonX</h1>

            <p className="text-lg md:text-xl mb-6">
            FluxtonX is a leading software company with everything you need to run &
grow your business.
            </p>
            <button className="bg-transparent border-2 border-sky-500 text-lg font-bold text-sky-500 px-10 py-3 rounded-bl-3xl rounded-tr-3xl hover:bg-custom-blue hover:text-white hover:transition hover:duration-500 hover:bg-gradient-to-r hover:from-transparent hover:to-sky-500 ">
              Start Now
            </button>
