...
const AboutCompany = () => {
  return (
    <div
      className="flex gap-x-8 justify-center items-center px-[5rem] py-20 about-company-card max-w-[1800px]"
      ...
      <div className="max-w-[600px] about-company-detail" data-aos="fade-left">
        ...
        <div className="">
          <div className="flex flex-col font-alegreya gap-y-2 py-4">
            ...
            <div
              className="text-2xl font-normal font-alegreya tracking-widest max1100:text-xl about-company-desc2 text-white"
              style={{
